...
export default function Tasks() {
  ...
  ${task.followup_status === "Escalated"
                        ? "bg-red-100 text-red-600"
                        : task.followup_status === "Closed"
    ...
    "
                ...
                <td className="p-3">
                  <span
                    className={`px-2 py-1 rounded text-xs ${getRisk(task) === "High"
                      ? "bg-red-100 text-red-600"
                      : getRisk(task) === "Medium"
                        ? "bg-yellow-100 text-yellow-700"
